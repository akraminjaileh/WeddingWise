...
namespace WeddingWise_Core.Migrations
{
    ...
    [Migration("20240508202510_UpdateConstraintAndProp")]
    partial class UpdateConstraintAndProp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.AgentTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 5, 8, 23, 25, 10, 230, DateTimeKind.Local).AddTicks(7965));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.CarRental", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 23, 25, 10, 231, DateTimeKind.Local).AddTicks(541));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.Reservation", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 23, 25, 10, 231, DateTimeKind.Local).AddTicks(9323));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.Room", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 23, 25, 10, 232, DateTimeKind.Local).AddTicks(9775));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 23, 25, 10, 239, DateTimeKind.Local).AddTicks(6841));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.WeddingHall", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 23, 25, 10, 240, DateTimeKind.Local).AddTicks(2390));
