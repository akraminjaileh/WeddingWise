...
namespace WeddingWise_Core.Migrations
{
    ...
    [Migration("20240424143713_First")]
    partial class First
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.AgentTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 4, 24, 17, 37, 12, 340, DateTimeKind.Local).AddTicks(3927));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.CarRental", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 24, 17, 37, 12, 340, DateTimeKind.Local).AddTicks(6124));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.Reservation", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 24, 17, 37, 12, 341, DateTimeKind.Local).AddTicks(1251));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.ReservationCar", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 24, 17, 37, 12, 340, DateTimeKind.Local).AddTicks(9423));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.ReservationWeddingHall", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 24, 17, 37, 12, 341, DateTimeKind.Local).AddTicks(3960));
                    ...
                    b.ToTable("ReservationWeddingHalls", t =>
                        {
                            ...
                            t.HasCheckConstraint("CH_ReservationWeddingHall_SweetType", "SweetType BETWEEN 101 AND 104");
                        });
                });
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.Room", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 24, 17, 37, 12, 341, DateTimeKind.Local).AddTicks(5684));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 24, 17, 37, 12, 341, DateTimeKind.Local).AddTicks(7665));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.WeddingHall", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 24, 17, 37, 12, 342, DateTimeKind.Local).AddTicks(2597));
