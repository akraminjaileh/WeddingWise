...
namespace WeddingWise_Core.Migrations
{
    ...
    [Migration("20240430013308_UpdateConstraint")]
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.AgentTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 4, 30, 4, 33, 7, 488, DateTimeKind.Local).AddTicks(8021));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.CarRental", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 30, 4, 33, 7, 489, DateTimeKind.Local).AddTicks(1062));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.Reservation", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 30, 4, 33, 7, 490, DateTimeKind.Local).AddTicks(928));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.ReservationCar", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 30, 4, 33, 7, 489, DateTimeKind.Local).AddTicks(5384));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.ReservationWeddingHall", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 30, 4, 33, 7, 490, DateTimeKind.Local).AddTicks(9300));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.Room", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 30, 4, 33, 7, 491, DateTimeKind.Local).AddTicks(3191));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 30, 4, 33, 7, 500, DateTimeKind.Local).AddTicks(4160));
            ...
            modelBuilder.Entity("WeddingWise_Core.Models.Entities.WeddingHall", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 30, 4, 33, 7, 501, DateTimeKind.Local).AddTicks(2002));
